...
public class DocumentCrawlerTest {
    ...
    public void testJavaInputExample() {
        ...
        configValues.put(DocumentCrawler.PREFIX_CONFIG.name(), prefix);
        configValues.put(DocumentCrawler.EVENT_COUNT_CONFIG.name(), eventCount);
        Configuration config = new ConfigurationImpl(configValues);
        DocumentCrawler input = new DocumentCrawler("test-id", config, null);
